    ...
    return (
        <>
            <div className="pt-16 md:pt-0 w-full md:w-6/12 lg:w-8/12 xl:w-9/12 flex flex-shrink-0 px-6 justify-center items-center h-full md:min-h-screen z-10">
                ...
                <div className="w-full md:w-110 h-full flex flex-col">
                    ...
                    <Link href={'/signup/password'}><Button label='Reset Password' buttonType='tertiary' size='lg' className='!w-full' /></Link>
                    </div>  
